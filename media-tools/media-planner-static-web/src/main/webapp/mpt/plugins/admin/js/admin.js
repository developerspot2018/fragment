app.factory('Validation',
	...
	function productCheck (data){
		if((data.name=="" || data.name==undefined) || (data.basePrice=="" || data.basePrice==undefined) || (data.type=="" || data.type==undefined) || (data.classs=="" || data.classs==undefined) || (data.creative == undefined || data.creative.length == 0)){
			var result = {};
			result.value = true;
			result.error = "Required fields are missing";
			return result;
